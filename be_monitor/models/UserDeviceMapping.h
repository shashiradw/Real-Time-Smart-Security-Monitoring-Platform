...
class UserDeviceMapping
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int32_t,std::string>;//user_id,device_id
     ...
     */
    explicit UserDeviceMapping(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserDeviceMapping(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserDeviceMapping(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    UserDeviceMapping() = default;
  ...
  private:
    friend drogon::orm::Mapper<UserDeviceMapping>;
    friend drogon::orm::BaseBuilder<UserDeviceMapping, true, true>;
    friend drogon::orm::BaseBuilder<UserDeviceMapping, true, false>;
    friend drogon::orm::BaseBuilder<UserDeviceMapping, false, true>;
    friend drogon::orm::BaseBuilder<UserDeviceMapping, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserDeviceMapping>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where user_id = $1 and device_id = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where user_id = $1 and device_id = $2";
        return sql;
    }
