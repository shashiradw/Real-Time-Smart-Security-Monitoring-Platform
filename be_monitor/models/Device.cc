...
const std::string Device::Cols::_name = "name";
...
Device::Device(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[0].empty() && pJson.isMember(pMasqueradingVector[0]))
    {
        ...
        {
            deviceId_=std::make_shared<std::string>(pJson[pMasqueradingVector[0]].asString());
        }
    }
...
const std::string &Device::getValueOfName() const noexcept
{
    const static std::string defaultValue = std::string();
    if(name_)
        return *name_;
...
const std::shared_ptr<std::string> &Device::getName() const noexcept
{
    return name_;
}
void Device::setName(const std::string &pName) noexcept
{
    name_ = std::make_shared<std::string>(pName);
    dirtyFlag_[1] = true;
}
void Device::setName(std::string &&pName) noexcept
{
